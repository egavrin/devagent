      ...
      steps: [
        {
          id: "find",
          tool: "find_files",
          args: { pattern: "packages/engine/src/tool-script*.ts" },
        },
      ],
    });
      ...
      steps: [
        {
          id: "find",
          tool: "find_files",
          args: { pattern: "packages/engine/src/index.ts" },
        },
        {
          id: "read",
          tool: "read_file",
      ...
      steps: [
        {
          id: "find",
          tool: "find_files",
          args: { pattern: "packages/core/src/types.ts" },
        },
        {
          id: "search",
          tool: "search_files",
        ...
        steps: JSON.stringify([
          {
            id: "tests",
            tool: "find_files",
            args: { pattern: "packages/engine/src/*.test.ts", max_results: 10 },
          },
          {
            id: "grep",
            tool: "search_files",
